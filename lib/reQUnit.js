 ...
 * @returns {*}
 */
exports.reStructure = function (ast) {
    return convertAST(ast);
};

exports.reQunit = function (codeData, ruleData) {
    var structAST = esprima.parse(codeData, {comment: true});
    var ruleAST = esprima.parse(ruleData, {comment: true});
    var reStructAST = convertAST(structAST);// change module structure
    var transformedAST = rephrase.astTransformAST(reStructAST, ruleAST);
    return escodegen.generate(transformedAST);
};
var syntax = {
